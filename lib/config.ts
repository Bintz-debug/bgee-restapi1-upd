...
export const siteConfig = {
  ...
  copyright: "© 2025 BintzGE. All rights reserved.",
  ...
  logo: {
    ...
    src: "https://files.catbox.moe/thgfch.jpg",
    width: 40,
    height: 40,
    alt: "BintzGE-RestApi's", // Alt text for accessibility
  ...
  background: {
    ...
    value: "https://files.catbox.moe/wxv6jg.jpg", // URL for image, gradient string, or pattern name
  ...
  // API information
  api: {
    baseUrl: "https://bintz-restapisimple.myvnc.com", // Updated base URL
    creator: "BintzGE",
    ...
    rateLimit: {
      ...
      headerPrefix: "B-RateLimit", // Prefix for rate limit headers
  ...
  // Social links
  links: {
    github: "https://youtube.com/@bintangghalielhaqyt",
  },

  // Status codes
  statusCodes: [
    { code: 200, name: "Sip ✅", description: "The request was successful." },
    ...
    { code: 502, name: "Bad Gateway 😑", description: "Bad gateway walahh" },
  ],
